...
void DirectionalLight::useLight(GLuint ambientIntensityLocation, GLfloat ambientColorLocation,
...
{
	return lightProj * glm::lookAt(-direction, glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));  // glm::vec3(0.0f, 0.0f, 1.0f) - Exception for when you are looking straight up or down
}
